...
void ModuleWindow::SetFullscreenBorderless(bool fullscreenBorderless)
{
	if (fullscreenBorderless) SDL_SetWindowFullscreen(window, SDL_WINDOW_FULLSCREEN_DESKTOP);
